<?php get_header(); ?>
		...
		<div id="content">
			<div class="posts">
				...
				<!-- titles -->
				<?php if(is_search()) { ?>
					<h2 class="archive-title"><i class="icon-search"></i> <?php /* Search Count */ $allsearch = &new WP_Query("s=$s&showposts=-1"); $count = $allsearch->post_count; _e('', 'okay'); echo $count . ' '; wp_reset_query(); ?><?php _e('Results for','okay'); ?> "<?php the_search_query() ?>" </h2>
				<?php } else if(is_tag()) { ?>
				...
				<?php } else if(is_author()) { ?>
					<h2 class="archive-title"><i class="icon-pencil"></i> <?php
